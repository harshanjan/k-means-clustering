...
df = pd.read_excel("C:/Users/user/Desktop/DATASETS/EastWestAirlines.xlsx", "data") #importing EastWest Airlines dataset
df.describe()
...
df.iloc[:, 2:12].groupby(df.cluster).mean()

df.to_csv("EW_Airlines.csv", encoding = "utf-8")
